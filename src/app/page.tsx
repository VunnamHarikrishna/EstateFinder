    ...
    <div className="min-h-screen flex flex-col pb-20">
      ...
      <main className="flex-grow container mx-auto px-4 pt-6">
        ...
        <div className="mt-12">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-3xl font-headline font-bold">Featured Listings</h2>
        ...
        {/* Categories Section */}
        <div className="mt-20">
          <h2 className="text-2xl font-headline font-bold mb-8">Explore by Category</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <Button 
                key={cat.label} 
                variant="outline" 
                className="h-24 flex-col gap-2 hover:border-primary hover:text-primary transition-all duration-300"
      ...
      <footer className="mt-20 border-t bg-white py-12">
        <div className="container mx-auto px-4 text-center">
          <span className="font-headline font-bold text-2xl text-primary">EstateFinder India</span>
          <p className="text-muted-foreground mt-2 max-w-md mx-auto">
            Your trusted partner in finding premium Indian real estate solutions since 2010.
          </p>
          ...
          <p className="text-xs text-muted-foreground mt-8">© 2024 Pavan EstateFinder India. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
